defmodule Circuit3a.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      {:nerves_system_rpi, "~> 1.20", runtime: false, targets: :rpi},
      {:nerves_system_rpi0, "~> 1.20", runtime: false, targets: :rpi0},
      {:nerves_system_rpi2, "~> 1.20", runtime: false, targets: :rpi2},
